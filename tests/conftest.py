...
from ecospheres_universe.datagouv import INACTIVE_OBJECT_MARKERS
    ...
    def _run_mock_feed(
        ...
        _ = responses.get(
            ...
            json={
                "records": [
                    {
                        "fields": {
                            "Type": MockOrganization.CLASS_NAME,
        ...
        for object_class in MockTopic.object_classes():
            ...
            _ = responses.get(
                ...
                match=[
                    ...
                    query_param_matcher({"class": object_class.classname()}, strict_match=False),
                ],
                json={
                    "data": [
                        {
                            "id": e.id,
                            "element": {"class": object_class.classname(), "id": e.object.id},
                        }
            ...
            if additions:
                ...
                _ = responses.post(
                    ...
                    match=[
                        ...
                        json_params_matcher(
                            [
                                {"element": {"class": object_class.classname(), "id": oid}}
        ...
        for object_class in MockTopic.object_classes():
            assert json_load_path(
                config.output_dir
                / f"organizations-{object_class.namespace()}-{config.env.value}.json"
            ) == mock_organizations_file(upcoming_universe.organizations(object_class))
